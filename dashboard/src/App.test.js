      ...
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        <div
          ...
          style={{
            ...
            cursor: "pointer",
            marginBottom: 24,
            background: dragOver ? "#1a1500" : "#111827",
            transition: "all 0.2s",
          }}
        >
        ...
        >
          {[
            ...
            [
              ...
              "Follows people across camera angles",
            ],
            [
              "⏱",
              "Dwell Time Analysis",
              "Measures how long each visitor stays",
            ],
...
function DashboardScreen({ onReset }) {
  ...
  const fetchData = () => {
    axios
      ...
      .catch(() => {});
    axios
      .get(`${API}/metrics/persons`)
      .then((r) => setPersons(r.data))
      .catch(() => {});
    axios
      .get(`${API}/metrics/hourly`)
      .then((r) => setHourly(r.data))
      .catch(() => {});
    axios
      .get(`${API}/metrics/business_iq`)
      .then((r) => setBiq(r.data))
      .catch(() => {});
  };
    ...
    >
      ...
      {summary && (
        ...
        >
          <KPICard
            ...
            detail="unique persons identified"
          />
          <KPICard
            icon="⏱"
            label="Avg Time in Venue"
            color="#3b82f6"
            value={dwellLabel(summary.avg_dwell_seconds)}
            detail="from entry to exit"
          />
          <KPICard
            icon="📈"
            label="Longest Stay"
            color="#8b5cf6"
            value={dwellLabel(summary.max_dwell_seconds)}
            detail="maximum dwell recorded"
          />
          <KPICard
            icon="🚪"
        ...
        >
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            ...
            >
              ...
              <div style={{ color: biq.color, fontSize: 22, fontWeight: 800 }}>
                {biq.grade}
              </div>
            </div>
            <div
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            ...
            {[
              ...
              <div key={label} style={{ marginBottom: 12 }}>
                ...
                <div
                  style={{ background: "#1f2937", borderRadius: 4, height: 6 }}
                >
                  <div
                    style={{
                      width: `${score}%`,
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {[
              summary.abandonment_rate_pct === 100
                ? {
                    text: "⚠️ All visitors left unattended — staff response needed",
                    type: "warning",
                  }
                : summary.abandonment_rate_pct > 50
                  ? {
                      text: `⚠️ ${summary.abandonment_rate_pct}% abandonment rate — high`,
                      type: "warning",
                    }
                  : {
                      text: `✅ ${100 - summary.abandonment_rate_pct}% of visitors were attended`,
                      type: "good",
                    },
              summary.avg_dwell_seconds > 300
                ? {
                    text: "⏱ Avg wait over 5 min — consider more floor staff",
                    type: "warning",
                  }
                : {
                    text: `⏱ Avg dwell ${dwellLabel(summary.avg_dwell_seconds)} — within normal range`,
                    type: "good",
                  },
              {
                text: `👥 ${summary.total_visitors} unique visitor${summary.total_visitors !== 1 ? "s" : ""} tracked`,
                type: "info",
              },
            ].map((ins, i) => (
              <span
      ...
      >
        ...
        <div style={{ display: "flex", gap: 20, marginTop: 16 }}>
          {[
            ["#10b981", "Served by staff"],
            ["#f59e0b", "Left unattended"],
          ].map(([c, l]) => (
            <div
              key={l}
              style={{
            ...
            {hourly.map((h) => (
              <div key={h.hour}>
                ...
                >
                  ...
                  <span style={{ color: "#f9fafb", fontWeight: 700 }}>
                    {h.visitors} visitor{h.visitors !== 1 ? "s" : ""} · avg{" "}
                    {dwellLabel(h.avg_dwell_seconds)}
                  </span>
                </div>
                <div
                  style={{
      ...
      >
        ...
        >
          <thead>
            <tr>
              {["Visitor", "Arrived", "Camera", "Time in Venue", "Outcome"].map(
                (h) => (
                  <th
                    key={h}
                    style={{
      ...
      >
        ...
        <p style={{ color: "#4b5563", fontSize: 13, margin: "0 0 16px" }}>
          Ask anything in plain English — powered by AI, no technical knowledge
          needed.
        </p>
        <div
          style={{
